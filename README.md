<p align="center">
  <img src="assets/logo_black.png" alt="OphthalmoGuide Logo">
</p>

Информационно-справочная система предварительной диагностики офтальмологических заболеваний, которая извлекает клинические симптомы из текстовой или голосовой жалобы пользователя с помощью локальной языковой модели (LLM) и сопоставляет их с базой знаний заболеваний по взвешенному алгоритму
...
* **Интерфейс управления базой данных (DBX):** `http://{PUBLIC_HOST}:4224` (доступ к PostgreSQL и Valkey).
